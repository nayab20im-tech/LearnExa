...
const LiveMonitoring = () => {
  ...
  const loadSubmissionForReview = useCallback(
    async (submissionId) => {
  ...
  const saveReview = async () => {
    ...
    const shortAnswers = reviewQuestions.filter(
    ...
    for (const item of shortAnswers) {
      ...
      if (
        ...
        setReviewError(
          `The score for "${
            item.question?.text || 'Short answer'
  ...
  if (loading) {
    return (
      <div className="empty-panel">
        ...
        <p>
          Connecting to active quiz sessions...
        </p>
      </div>
    );
  }
    ...
    <div className="monitoring-page">
                            ...
                            <Row className="g-3">
                              ...
                              <Col md={9}>
                                ...
                                <Form.Control
                                  ...
                                  placeholder="Explain the awarded marks to the student."
                                  disabled={
                                    reviewSaving
                                  }
                                />
      ...
      <div className="page-heading-row">
        <div>
          ...
          <p>
            Detect focus loss, minimized
            windows, copying attempts,
            automatic locks, and runtime AI
            evaluation.
          </p>
        </div>
